...
namespace Face_Recognition
{
    public partial class Form1 : Form
    {
        ...
        public void retrain()
        {
            ...
            {
                message_bar.Text = "No training data found, please train program using Train button";
            }
        }
        ...
        void FrameGrabber_Standard(object sender, EventArgs e)
        {
            ...
            if (currentFrame != null)
            {
                ...
                for (int i = 0; i < facesDetected.Length; i++)// (Rectangle face_found in facesDetected)
                {
                    ...
                    currentFrame.Draw(facesDetected[i], new Bgr(Color.YellowGreen), 2);
                    ...
                    if (Eigen_Recog.IsTrained)
                    {
                        ...
                        currentFrame.Draw(name + " ", ref font, new Point(facesDetected[i].X - 2, facesDetected[i].Y - 2), new Bgr(Color.Yellow));
